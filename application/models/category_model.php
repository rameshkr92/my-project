...
class Category_model extends CI_Model
{
	...
	public function getParentCategories($productcnts)
	{
		$sql = 
		"
			SELECT cat.category_id, cat.category_name,cat.category_image FROM ".DBPREFIX."_categories AS cat		
	...
	{
		$sql = "
			SELECT subcat.category_id, subcat.parent_category_id, subcat.category_name,subcat.category_image FROM ".DBPREFIX."_categories AS subcat										
