					...
					<ul class="nav nav-tabs nav-stacked main-menu">						
						...
						<?php
							...
							(
								0=>array
								(
									"heading" =>array("iconclass"=>"icon-film","icontext"=>"Carousel"),
									"data"=>array
									(
										0=>array("url"=>base_url()."admin/carousel","text"=>"Carousel List","module"=>"carousel")
									)
								),
								1=>array
								(
								...
								5=>array
								(
									"heading" =>array("iconclass"=>"icon-user","icontext"=>"Vendors"),
									"data"=>array
									(
										0=>array("url"=>base_url()."admin/vendors","text"=>"Vendors List","module"=>"vendors"),
										1=>array("url"=>base_url()."admin/areas","text"=>"Areas List","module"=>"areas")
									)
								),
								6=>array
								(
									"heading" =>array("iconclass"=>"icon-user","icontext"=>"Purchase"),
									"data"=>array
									(
										0=>array("url"=>base_url()."admin/purchaseinvoice/Invoice_list","text"=>"Purchase Invoice List","module"=>"purchaseinvoice")
									)
								),
								7=>array
								(
									"heading" =>array("iconclass"=>"icon-user","icontext"=>"Sales"),
									"data"=>array
									(
										0=>array("url"=>base_url()."admin/sales/pendingOrders","text"=>"Pending Orders","module"=>"sales"),
										1=>array("url"=>base_url()."admin/sales/sales_invoice","text"=>"Sales Invoice","module"=>"sales")
									)
								),
							);
