	...
	class Securearea extends CI_Controller
	{
		...
		//	echo "<pre>";print_r($getData);die;
			...
			{			
				...
				$userData = $this->checklogindetails($getData["userid"],$getData["password"]);
				if($userData)
				{
					$this->isloggedin = TRUE;
					$this->userData = $userData[0];
			...
			else if($this->session->userdata("userid") && $this->session->userdata("password"))
			{
				$userData = $this->checklogindetails($this->session->userdata("userid"),$this->session->userdata("password"));
				if($userData)
				{
					$this->isloggedin = TRUE;
					$this->userData = $userData[0];
